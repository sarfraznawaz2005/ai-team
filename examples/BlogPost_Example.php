...
$SeniorResearchAnalyst = (new Member(
    ...
    ->assignTask(
        "Analyze 2024's AI advancements. Find major trends, new technologies, and their effects. 
...
$TechContentStrategist = (new Member(
    ...
    'Create a blog post about major AI advancements using your insights. Make it interesting, clear, and suited
     for tech enthusiasts. It should be at least 4 paragraphs long.'
);

$blogTeam = new Team(
    'See the findings of experts and write an engaging and consolidated blog post based on their findings.',
    new GoogleGeminiAI($apiKey)
);

$blogTeam->addMembers([$SeniorResearchAnalyst, $TechContentStrategist]);
