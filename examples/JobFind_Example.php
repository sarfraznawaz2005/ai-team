...
// define members with roles, goals and tasks with same or different AI models/LLMs
...
$JobSearcher = (new Member(
    ...
    "Search for current job openings for the Senior Data Scientist role in New York using the provided information.
...
$SkillsDevelopmentAdvisor = (new Member(
    ...
    'Based on the identified job openings, list the key skills required for each position separately.
...
$InterviewPreparationCoach = (new Member(
    ...
    'Prepare job searchers for interviews by conducting mock interviews and offering feedback on their responses,
...
$CareerAdvisor = (new Member(
    ...
    'Offer guidance on resume building, optimizing LinkedIn profiles, and effective networking strategies to enhance
